...
import { VerificarCorreoIcon } from '../../../app/media/icons/verificar-correo-icon/verificar-correo-icon';

@Component({
  imports: [KcClassDirective, KcSanitizePipe, InputOtpModule, FormsModule, VerificarCorreoIcon],
